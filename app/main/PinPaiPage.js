...
let datas=[];
export default class PinPai extends BaseComponent {
    constructor(props) {
        super(props);
        this.ds = new ListView.DataSource({rowHasChanged: (r1, r2) => r1 !== r2});
        this.state = {
            navTitle: '首页',
            dataSource: this.ds.cloneWithRows(this.props.pin),
            isShow:true,
        };
            ...
            <View style={[styles.everyview,rowData.flag ? {borderColor:'red',borderWidth:1} : {}]}>
                <TouchableOpacity onPress={
                    () => {
                        ...
                        console.log('PinPaic',rowData.title)
                        this.props.pingClick(rowData.title);
                    }}>
