...
export default class MainPage extends BaseComponent {
    ...
    _renderRow = (rowData) => {
            console.log('----',rowData);
              ...
              if(rowData=='4'){
                ...
                <View style={{flex:1,height:Pixel.getPixel(105)}}>
                    ...
                    <Text style={{fontSize:12,marginTop:Pixel.getPixel(7),marginLeft:Pixel.getPixel(15)}}>里程:20.59万</Text>
                </View>
                 )
            ...
            return (
                <View style={{flex:1,height:Pixel.getPixel(40)}}>
                    <Text style={{fontSize:25,marginTop:Pixel.getPixel(10),marginLeft:Pixel.getPixel(15)}}>采购信息</Text>
        ...
        if(rowData=='9'){
            ...
            return (
                <View style={{flex:1,height:Pixel.getPixel(40)}}>
                    <Text style={{fontSize:25,marginTop:Pixel.getPixel(10),marginLeft:Pixel.getPixel(15)}}>卖家信息</Text>
