/**
 * Created by xujiaqi on 2017/12/20.
 */
...
export default class MainRoot extends BaseComponent {
            constructor(props) {
                super(props);
                    ...
                    <View style={{height: 44}}>
                        <TouchableOpacity onPress={this.getMoviesFromApiAsync}>
                            <Text style={{
                                ...
                                marginLeft: 15,
                                fontSize: 15
                            }}>{rowData.title == undefined ? rowData : rowData.title}</Text>
                        </TouchableOpacity>
                        <View style={{width: 375, height: 1, backgroundColor: "gainsboro"}}></View>
                        <Image source={require('../../image/p7.png')}
                               style={{width: 22, height: 11, marginLeft: 345, marginTop: -28}}></Image>
